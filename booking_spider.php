...
if(isset($_POST['package'])){
  ...
  $_SESSION['db'] = 'seat_spider';
  $_SESSION['movie'] = "Spider-Man: Across the Spider-Verse";
...
<div class="container">
    ...
    <img src="posterspider.jpg" alt="Movie Poster" class="movie-image">
    <h2>Spider-Man: Across the Spider-Verse</h2>
      <p class="font"><i>In the film, Miles goes on an adventure with Gwen Stacy / Spider-Woman across the multiverse where he meets a
         team of Spider-People known as the Spider-Society, led by Miguel O'Hara / Spider-Man 2099, 
         but comes into conflict with them over handling a new threat in the form of the Spot.</i></p>
