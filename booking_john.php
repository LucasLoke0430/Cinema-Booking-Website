...
if(isset($_POST['package'])){
  ...
  $_SESSION['db'] = 'seat_john';
  $_SESSION['movie'] = "John Wick: Chapter 4";
...
<div class="container">
    ...
    <img src="posterjohn.jpg" alt="Movie Poster" class="movie-image">
    <h2>John Wick: Chapter 4</h2>
      <p class="font"><i>John Wick uncovers a path to defeating The High Table. 
      But before he can earn his freedom, Wick must face off against a new enemy with powerful alliances across the globe and 
      forces that turn old friends into foes.</i></p>
