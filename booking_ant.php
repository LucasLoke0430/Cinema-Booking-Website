...
if(isset($_POST['package'])){
  ...
  $_SESSION['db'] = 'seat_ant';
  $_SESSION['movie'] = "Ant-Man and the Wasp: Quantumania";
...
<div class="container">
    ...
    <img src="posterant.jpg" alt="Movie Poster" class="movie-image">
    <h2>Ant-Man and the Wasp: Quantumania</h2>
      <p class="font"><i>Scott Lang and Hope Van Dyne are dragged into the Quantum Realm, along with Hope's parents and Scott's daughter Cassie. 
        Together they must find a way to escape, but what secrets is Hope's mother hiding? 
        And who is the mysterious Kang?</i></p>
